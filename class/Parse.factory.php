...
class ParseFactory{
    ...
    function __construct($path = './datas/', $itemsPerPage = null ,$numLinksDisplayed = null)
    {
        ...
        /* PARSE FILE */
        $this->_files       = new filemanip($path); //Objet fichier 
        $this->_pagination  = new Pagination($this->_files->_get('ListFiles'),  $itemsPerPage , $numLinksDisplayed); //Objet pagination

        //HL7 - HPRIM

        $this->_map    = new MapProtocol('hprim'); //Objet parsing HPRIM
